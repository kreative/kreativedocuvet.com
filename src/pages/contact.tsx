...
import { Envelope, Phone, Note, ArrowUpRight } from "@phosphor-icons/react";
        ...
        <Container>
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12 md:col-span-6 lg:col-span-4">
              <div className="bg-neutrals-2 rounded-2xl p-10 flex flex-col space-y-6 col-span-2 sm:col-span-1 border border-neutrals-5">
                <Envelope size={50} className="text-brand-seafoam" />
                <h2 className="text-3xl tracking-tight">Email</h2>
                <p className="text-horizon-grey-600">
                  Send us a message anytime and one of our team members will get
                  back to you as soon as possible.
                </p>
                <a
                  href="mailto:hello@kreativedocuvet.com"
                  className="underline text-lg hover:text-brand-seafoam"
                >
                  hello@kreativedocuvet.com
                </a>
              </div>
            </div>
            <div className="col-span-12 md:col-span-6 lg:col-span-4">
              <div className="bg-neutrals-2 rounded-2xl p-10 flex flex-col space-y-6 col-span-2 sm:col-span-1 border border-neutrals-5">
                <Phone size={50} className="text-brand-seafoam" />
                <h2 className="text-3xl">Book a call</h2>
                <p className="text-horizon-grey-600">
                  Have questions only a human can answer? Book a time with one
            ...
            <div className="grid grid-cols-12 gap-0 ">
              <div className="col-span-12 sm:col-span-7 flex flex-col justify-center space-y-2">
                ...
                <p className="pb-6 text-[18px]">
                  For any product, billing, or technical issues with DocuVet,
                  please feel free to reach out to our support team. We promise
                  to resolve your issue fast!
                </p>
              ...
              <div className="col-span-12 sm:col-span-4 flex justify-center items-center mt-10 sm:0">
                <svg
                  className="w-[50%] sm:w-[75%] h-auto"
                  viewBox="0 0 250 249"
                  fill="none"
